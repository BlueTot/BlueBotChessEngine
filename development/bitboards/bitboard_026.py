...
class Board:
    ...
    def __intersection_sqrs(self, no_king, protected, isPawn=False): # Get intersection squares with options
        if protected:
    ...
    def __pawn_atk_squares(self, sq, no_king=False, protected=False): # Get pawn attack squares
        if self.__turn:
            return PAWN_ATK_WHITE_SQRS[sq] & self.__intersection_sqrs(no_king, protected, isPawn=True)
        else:
            return PAWN_ATK_BLACK_SQRS[sq] & self.__intersection_sqrs(no_king, protected, isPawn=True)

    def __knight_squares(self, sq, no_king=False, protected=False): # Get knight squares
        return KNIGHT_SQRS[sq] & self.__intersection_sqrs(no_king, protected)
    ...
    def __king_squares(self, sq, no_king=False, protected=False): # Get king squares
        return KING_SQRS[sq] & self.__intersection_sqrs(no_king, protected)
    ...
    def __bishop_squares(self, sq, no_king=False, protected=False): # Get bishop squares
        ...
        return self.__intersection_sqrs(no_king, protected) & (nw_sqrs | ne_sqrs | sw_sqrs | se_sqrs)
    ...
    def __rook_squares(self, sq, no_king=False, protected=False): # Get rook squares
        ...
        return self.__intersection_sqrs(no_king, protected) & (n_sqrs | e_sqrs | s_sqrs | w_sqrs)
