...
class Board:
    ...
    def __init__(self): # Constructor
        ...
        # stacks
        self.__move_stack = []
        self.__state_stack = [[self.__board_bb[:], self.__castling_rights, self.__en_passant_square, self.__white_pieces, self.__black_pieces]]
    ...
    def pseudo_legal_moves(self): # Pseudo-legal moves
        # return self.generate_pawn_moves()
    ...
    def legal_moves(self): # Legal moves
        ...
        for move in pseudo_legal_moves:
            ...
            self.pop()
        # return pseudo_legal_moves + self.generate_king_moves()
    ...
    def push(self, move): # Push move
        ...
        self.__state_stack.append([tuple(self.__board_bb), tuple(self.__castling_rights), self.__en_passant_square, self.__white_pieces, self.__black_pieces]) 
