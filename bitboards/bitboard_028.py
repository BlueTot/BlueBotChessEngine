...
BB_SQRS = [9223372036854775808, 4611686018427387904, 2305843009213693952, 1152921504606846976, 
...
class Board:
    ...
    def generate_king_moves(self): # Generate king moves
        ...
        for Ksq in self.__squares_from(self.__board_bb[10 if self.__turn else 11]):
            for sq in self.__squares_from(self.__king_squares(Ksq) & ~(non_legal_sqrs | protected_sqrs)):
